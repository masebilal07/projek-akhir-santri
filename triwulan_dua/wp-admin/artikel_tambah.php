  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="box">
       ...
       <div class="box-body">
          <form action="proses/proses_tambah_artikel.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="col-sm-10">
                    <select name="kategori" class="form-control">
                      <option value="0">-Silahkan Jangan di Pilih-</option>
                      <?php 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea id="editor1" name="isi" class="form-control" placeholder="isi">
                    </textarea>
                  </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select type="text" name="penulis" class="form-control" placeholder="Penulis">
                      <?php 
                      include 'proses/koneksi.php';
                        $sql = mysqli_query($connect, "SELECT * FROM author ORDER BY id DESC");
                        while ($row = mysqli_fetch_array($sql)) {
                          echo "<option value='$row[id]'>".$row['nama']."</option>";
                        }
                      ?>
