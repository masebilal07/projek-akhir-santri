...
<div class="wrapper">
 ...
 <!--      <div class="user-panel">
        <div class="pull-left image">
          <img src="images/bilal.jpg" class="gambar" alt="User Image">
        </div>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="artikel_tambah.php" class="btn btn-primary pull-right">Tambah Data</a>
        </div>
         <div class="box-body">
                ...
                <tbody>
                      ...
                      while ($row = mysqli_fetch_array($sql)) {
                        ...
                        <tr>
                          ...
                          <td>".(($row['status'] == '1') ? '<span class="label label-success">AKTIF</span>' : '<span class="label label-danger">TIDAK AKTIF</span>')."</td>
                          <td>".date('d F Y', strtotime($row['tanggal']))."</td>
                          <td>
                            <a class='btn btn-info btn-xs' href='artikel_edit.php?ID=$row[id]'>
                            <i class='fe fe-pencil'></i> Edit
                            </a>
                            <a class='btn btn-danger btn-xs delete' href='proses/proses_hapus_artikel.php?ID=$row[id]'>
                            <i class='fe fe-trash-o'></i> Hapus
                            </a>
                          </td>
                        </tr>
                        ";
