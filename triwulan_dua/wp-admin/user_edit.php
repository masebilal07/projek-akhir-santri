  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form action="proses/proses_user_edit.php" method="post" class="form-horizontal">
            <?php 
            ...
            <input type="hidden" name="id" value="<?= $id?>">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="email" name="email" class="form-control" placeholder="Alamat Email" value="<?=$row['email'];?>">
                </div>
              </div>
              <div class="form-group">
