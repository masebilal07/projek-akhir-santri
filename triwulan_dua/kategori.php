    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="kategori_tambah.php" class="btn btn-primary pull-right">Tambah Data</a>
        </div>
        <div class="box-body">
                ...
                <tbody>
                     <?php 
                        ...
                        while ($row = mysqli_fetch_array($sql)) {
                          ...
                          <td>
                            <a class='btn btn-info btn-xs' href='kategori_edit.php?ID=$row[id]'>
                              <i class='fa fa-pencil'></i> Edit
                            </a>
                            <a class='btn btn-danger btn-xs delete' href='proses/proses_kategori_hapus.php?ID=$row[id]'>
